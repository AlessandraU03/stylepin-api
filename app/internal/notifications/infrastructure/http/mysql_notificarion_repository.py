...
class MySQLNotificationRepository(NotificationRepository):
    ...
    async def mark_as_read(self, notification_id: str) -> NotificationEntity:
        ...
        try:
            ...
            db_notification.read_at = datetime.utcnow()  # ✅ AGREGAR
            self.db.commit()
            self.db.refresh(db_notification)
    ...
    def _to_domain(db_notification: Notification) -> NotificationEntity:
        ...
        return NotificationEntity(
            ...
            type=db_notification.type.value if db_notification.type else "like",  # ✅ Convertir Enum a string
            ...
            read_at=db_notification.read_at  # ✅ AGREGAR
        )