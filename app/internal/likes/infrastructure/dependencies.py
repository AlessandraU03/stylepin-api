...
from app.internal.likes.infrastructure.adapters.mysql_like_repository import MySQLLikeRepository
...
def get_like_controller(db: Session = Depends(get_db)) -> LikeController:
    ...
    return LikeController(
        like_uc=LikePinUseCase(like_repo),
        unlike_uc=UnlikePinUseCase(like_repo),
        toggle_like_uc=ToggleLikeUseCase(like_repo, pin_repo, user_repo),  # ✅ Pasar user_repo
